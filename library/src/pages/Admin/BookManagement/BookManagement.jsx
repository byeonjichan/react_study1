...
function BookManagement(props) {
    ...
    useEffect(() => {
        ...
        bookTypeName.setValue(() => ({value: selectedBook.bookTypeId, label:selectedBook.bookTypeName}))
        categoryName.setValue(() => ({value: selectedBook.categoryId, label:selectedBook.categoryName}))
